...
__export(main_exports, {
  default: () => VaultOpsOrphanFinderPlugin
});
...
var VaultOpsOrphanFinderPlugin = class extends import_obsidian.Plugin {
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: () => {
        new import_obsidian.Notice("Vault Ops - Orphan Finder is active.");
      }
    });
...
var VaultOpsOrphanFinderSettingTab = class extends import_obsidian.PluginSettingTab {
  plugin;
